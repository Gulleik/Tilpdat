...
//antall plasser i N_BUTTON_DATA matrisen
#define N_BUTTON_DATA 2
...
static int button_data[N_BUTTON_DATA];
...
int elev_check_order(){
    ...
    for (i = 0; i < N_FLOORS; i++){
        for (j = 0; j < N_BUTTONS; j++){
            is_button_pressed = io_read_bit(button_channel_matrix[i][j]);
